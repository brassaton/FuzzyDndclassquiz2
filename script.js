const QUESTIONS = [
  ...
  {category:"Flavor",trait:"flavor",phase:"adaptive",text:"Would you rather support allies with spells than with weapons and armor?",answers:[["YES",{classes:{"Cleric":3,"":3,"Sorcerer":3},classes:{"Fighter":-3,"Paladin":-3,"Ranger":-3},flavor:true}],["NO",{classes:{"Cleric":-3,"":-3,"Sorcerer":-3},classes:{"Fighter":3,"Paladin":3,"Ranger":3},flavor:true}]]},
  {category:"Flavor",trait:"flavor",phase:"adaptive",text:"Would you rather improve allies with inspiration and abilities than restore their HP?",answers:[["YES",{classes:{"":3},classes:{"Cleric":-3,"Paladin":-3,"Druid":-3},flavor:true}],["NO",{classes:{"":-3},classes:{"Cleric":3,"Paladin":3,"Druid":3},flavor:true}]]},
  ...
  {category:"Flavor",trait:"flavor",phase:"adaptive",text:"Would you rather use constructs, infusions, or gadgets to support the party?",answers:[["YES",{classes:{"Artificer":3},classes:{"":-3,"Cleric":-3,"Druid":-3},flavor:true}],["NO",{classes:{"Artificer":-3},classes:{"":3,"Cleric":3,"Druid":3},flavor:true}]]},
  ...
  {category:"Flavor",trait:"flavor",phase:"adaptive",text:"Would you rather solve problems with a large spellbook of different magic?",answers:[["YES",{classes:{"Wizard":3},classes:{"Rogue":-3,"":-3,"Artificer":-3},flavor:true}],["NO",{classes:{"Wizard":-3},classes:{"Rogue":3,"":3,"Artificer":3},flavor:true}]]},
  {category:"Flavor",trait:"flavor",phase:"adaptive",text:"Would you rather solve problems with skills, tricks, and deception instead of spells?",answers:[["YES",{classes:{"Rogue":3,"":3},classes:{"Wizard":-3,"Sorcerer":-3},flavor:true}],["NO",{classes:{"Rogue":-3,"":-3},classes:{"Wizard":3,"Sorcerer":3},flavor:true}]]},
  ...
  {category:"Flavor",trait:"flavor",phase:"adaptive",text:"Would you rather control enemies with enchantment or illusion magic?",answers:[["YES",{classes:{"Wizard":3,"":3,"Warlock":3},classes:{"Fighter":-3,"Barbarian":-3},flavor:true}],["NO",{classes:{"Wizard":-3,"":-3,"Warlock":-3},classes:{"Fighter":3,"Barbarian":3},flavor:true}]]},
  ...
  {category:"Flavor",trait:"flavor",phase:"adaptive",text:"Would you rather cast a lot of spells throughout a fight?",answers:[["YES",{classes:{"Wizard":3,"Sorcerer":3,"Warlock":3,"Cleric":3,"Druid":3,"":3},classes:{"Fighter":-3,"Barbarian":-3,"Rogue":-3},flavor:true}],["NO",{classes:{"Wizard":-3,"Sorcerer":-3,"Warlock":-3,"Cleric":-3,"Druid":-3,"":-3},classes:{"Fighter":3,"Barbarian":3,"Rogue":3},flavor:true}]]},
  ...
  {category:"Flavor",trait:"flavor",phase:"adaptive",text:"Would you rather maintain magical effects than make repeated weapon attacks?",answers:[["YES",{classes:{"Wizard":3,"Warlock":3,"Druid":3,"Cleric":3,"":3},classes:{"Fighter":-3,"Rogue":-3,"Barbarian":-3},flavor:true}],["NO",{classes:{"Wizard":-3,"Warlock":-3,"Druid":-3,"Cleric":-3,"":-3},classes:{"Fighter":3,"Rogue":3,"Barbarian":3},flavor:true}]]},
  ...
  {category:"Flavor",trait:"flavor",phase:"adaptive",text:"Would you rather control enemies through fear, curses, or dark magic?",answers:[["YES",{classes:{"Warlock":3,"Death Knight":3},classes:{"":-3,"Wizard":-3},flavor:true}],["NO",{classes:{"Warlock":-3,"Death Knight":-3},classes:{"":3,"Wizard":3},flavor:true}]]},
  {category:"Flavor",trait:"flavor",phase:"adaptive",text:"Would you rather control enemies through social influence, charm, or words?",answers:[["YES",{classes:{"":3},classes:{"Wizard":-3,"Warlock":-3},flavor:true}],["NO",{classes:{"":-3},classes:{"Wizard":3,"Warlock":3},flavor:true}]]},
  ...
  {category:"Flavor",trait:"flavor",phase:"adaptive",text:"Would you rather support allies with inspiration-style buffs?",answers:[["YES",{classes:{"":3},classes:{"Cleric":-3,"Druid":-3,"Artificer":-3},flavor:true}],["NO",{classes:{"":-3},classes:{"Cleric":3,"Druid":3,"Artificer":3},flavor:true}]]},
  ...
  {category:"Flavor",trait:"flavor",phase:"adaptive",text:"Would you rather support allies with healing and protection?",answers:[["YES",{classes:{"Cleric":3,"Paladin":3,"Druid":3},classes:{"":-3,"Rogue":-3},flavor:true}],["NO",{classes:{"Cleric":-3,"Paladin":-3,"Druid":-3},classes:{"":3,"Rogue":3},flavor:true}]]},
  {category:"Flavor",trait:"flavor",phase:"adaptive",text:"Would you rather support allies with inventions, gadgets, and infusions?",answers:[["YES",{classes:{"Artificer":3},classes:{"":-3,"Cleric":-3},flavor:true}],["NO",{classes:{"Artificer":-3},classes:{"":3,"Cleric":3},flavor:true}]]},
  {category:"Flavor",trait:"flavor",phase:"adaptive",text:"Would you rather support the party through a companion or summoned creature?",answers:[["YES",{classes:{"Ranger":3,"Druid":3,"Artificer":3},classes:{"":-3,"Cleric":-3},flavor:true}],["NO",{classes:{"Ranger":-3,"Druid":-3,"Artificer":-3},classes:{"":3,"Cleric":3},flavor:true}]]},
  {category:"Flavor",trait:"flavor",phase:"adaptive",text:"Would you rather support allies by manipulating dice, rolls, or probability?",answers:[["YES",{classes:{"Sorcerer":3,"Wizard":3,"":3},classes:{"Fighter":-3,"Barbarian":-3,"Ranger":-3},flavor:true}],["NO",{classes:{"Sorcerer":-3,"Wizard":-3,"":-3},classes:{"Fighter":3,"Barbarian":3,"Ranger":3},flavor:true}]]},
...
const FINAL_FANTASY_QUESTIONS = [
  ...
  {category:"Class Fantasy",trait:"mobility",phase:"final",weight:8,text:"Do you want to rely on stealth and sneaking?",answers:[
    ["YES",{traits:{mobility:2,utility:1},classes:{Rogue:5,Ranger:2,Monk:2,Bard:3},weight:8}],
  ...
  {category:"Class Fantasy",trait:"range",phase:"final",weight:8,text:"Do you want to fight mainly from range?",answers:[
    ["YES",{traits:{range:2},classes:{Ranger:4,Fighter:3,Rogue:3,Wizard:3,Sorcerer:2,Warlock:2,Artificer:2},weight:8}],
  ...
  {category:"Class Fantasy",trait:"healing",phase:"final",weight:8,text:"Do you want healing or strong party support to be a major part of your kit?",answers:[
    ["YES",{traits:{healing:2,support:2},classes:{Cleric:4,Bard:4,Druid:4,Paladin:2,Artificer:3,Sorcerer:2,Warlock:-2},weight:8}],
    ["NO",{traits:{healing:-1,support:-1},classes:{Cleric:-5,Bard:-3,Druid:-3,Paladin:-1,Artificer:-2,Sorcerer:-1,Warlock:1},weight:8}]
  ]},
  {category:"Class Fantasy",trait:"utility",phase:"final",weight:10,text:"Do you want to be good at skills or tools?",answers:[
    ["YES",{traits:{chaos:5,utility:1},classes:{Rogue:5,Bard:5,Artificer:3,Ranger:3},weight:10}],
    ["NO",{traits:{chaos:-5},classes:{Rogue:-2,Bard:-2,Artificer:-2,Ranger:-2},weight:10}]
  ]},
